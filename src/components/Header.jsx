 ...
 const Header = ({title, image, type}) =>{
  return(
    <div className="w-full h-[100vh]">
      ...
      <div className="absolute h-full w-full bg-gradient-to-t from-black to-transparent top-0
      z-8 flex flex-col items-center justify-center pt-20 2xl:pt-10 px-4">
